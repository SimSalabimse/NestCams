...
class VideoProcessorApp:
    ...
    def process_video_thread(self):
        ...
        try:
            ...
            for start, end in segments:
                ...
                normalized_clip = process_clip_frames(clip, fps).fx(vfx.fadein, 0.5).fx(vfx.fadeout, 0.5)
                adjusted_clips.append(normalized_clip)
            
            # Step 3: Generate selected videos
    ...
    def handle_message(self, message):
        """Handle queue messages to update the UI."""
