...
def generate_output_video(input_path, output_path, desired_duration, selected_indices, clip_limit=1.0, saturation_multiplier=1.1, 
    ...
    """Generate video using pre-selected indices, adjusting for desired duration."""
    try:
...
class VideoProcessorApp:
    ...
    def process_video_thread(self):
        """Process videos in a separate thread with optimized motion detection."""
        try:
